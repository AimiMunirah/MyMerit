...
<html>
    ...
    <form action="loginSession.php" method="POST">  
      ...
      <div class="btn-group">
        <button type="submit" name="coData" class="btn btn-primary">Login</button>
		</div>
		<p>No account?<a href="coordRegister.php">Register</a> Here</p>
	</body>
